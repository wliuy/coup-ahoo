...
export class Scene extends Container {
    ...
    constructor(game: Game) {
        ...
        this.bigText = new WobblyText(game, '~ 阿胡起义 ~', 80, 400, 60, 0.2, 3, { shadow: 6, align: 'center', scales: true });
